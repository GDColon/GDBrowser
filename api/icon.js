    ...
    function(err1, res1, body1) {
      ...
      request.post(
        ...
        function(err2, res2, body2) {
          ...
          let robotOffset1;
          let robotGlow1 = `${form}_${iconID}_02_2_001.png`;
          let robotLeg2 = `${form}_${iconID}_03_001.png`;
          let robotOffset2;
          let robotGlow2 = `${form}_${iconID}_03_2_001.png`;
          let robotLeg3 = `${form}_${iconID}_04_001.png`;
          let robotOffset3;
          let robotGlow3 = `${form}_${iconID}_04_2_001.png`;
          let robotLeg3b;
          let robotLeg2b;
          let robotLeg1b;
          let robotLeg1c;
          ...
          if (fs.existsSync(`./icons/cache/${iconCode}.png`))
            res.sendFile(
              path.join(__dirname, `../icons/cache/${iconCode}.png`)
            );

          let ufoMode = false;
          let useExtra = false;

          let originalOffset = icons[
          ...
          if (robotMode || spiderMode) {
            ...
            robotLeg1 = new Jimp(`./icons/${robotLeg1}`);
            robotGlow1 = new Jimp(`./icons/${robotGlow1}`);
            robotLeg2 = new Jimp(`./icons/${robotLeg2}`);
            robotGlow2 = new Jimp(`./icons/${robotGlow2}`);
            robotLeg3 = new Jimp(`./icons/${robotLeg3}`);
            ...
            return img.scan(0, 0, img.bitmap.width, img.bitmap.height, function(
              ...
              if (
                ...
                this.bitmap.data[idx] =
                  colors[col].r / (255 / this.bitmap.data[idx]);
                this.bitmap.data[idx + 1] =
                  colors[col].g / (255 / this.bitmap.data[idx + 1]);
                this.bitmap.data[idx + 2] =
                  colors[col].b / (255 / this.bitmap.data[idx + 2]);
              }
            });
          }
          ...
          Jimp.read(glow).then(async function(image) {
            ...
            Jimp.read(icon).then(async function(ic) {
              ...
              ic.composite(
                glow,
                iconSize[0] / 2 - size[0] / 2 + offset[0],
                iconSize[1] / 2 - size[1] / 2 - offset[1],
              ...
              if (robotMode) {
                ...
                await Jimp.read(new Jimp(robotLeg1)).then(rob => {
                  ...
                  rob.composite(
                    robotGlow1,
                    robotOffset1[2] - robotOffset1b[2] + 1,
                    (robotOffset1[3] - robotOffset1b[3]) / 2,
                    { mode: Jimp.BLEND_DESTINATION_OVER }
                  );
                  robotLeg1 = rob;
                });
                ...
                await Jimp.read(new Jimp(robotLeg2)).then(rob => {
                  ...
                  rob.composite(
                    robotGlow2,
                    (robotOffset2[2] - robotOffset2b[2]) / 2,
                    (robotOffset2[3] - robotOffset2b[3]) / 2,
                    { mode: Jimp.BLEND_DESTINATION_OVER }
                  );
                  robotLeg2 = rob;
                });
                ...
                await Jimp.read(new Jimp(robotLeg3)).then(rob => {
                  ...
                  rob.composite(
                    robotGlow3,
                    (robotOffset3[2] - robotOffset3b[2]) / 2 - 2,
                    (robotOffset3[3] - robotOffset3b[3]) / 2,
                    { mode: Jimp.BLEND_DESTINATION_OVER }
                  );
                  robotLeg3 = rob;
                });
                ...
                ic.composite(
                  ...
                  100 +
                    ...
                    robotOffset2[0] -
                    31,
                  iconSize[1] / 2 - robotOffset2[3] - robotOffset2[1] + 73
                );
                ic.composite(
                  robotLeg3b,
                  100 +
                    ...
                    robotOffset3[0] +
                    20,
                  iconSize[1] / 2 - robotOffset3[3] - robotOffset3[1] + 78
                );
                ic.composite(
                  robotLeg2,
                  100 +
                ...
                ic.composite(
                  ...
                  100 +
                    ...
                    robotOffset1[0] -
                    20,
                  iconSize[1] / 2 - robotOffset1[3] - robotOffset1[1] + 50
                );
              }
              ...
              if (spiderMode) {
                ...
                await Jimp.read(new Jimp(robotLeg1)).then(rob => {
                  ...
                  rob.composite(
                    robotGlow1,
                    (robotOffset1[2] - robotOffset1b[2]) / 2,
                    (robotOffset1[3] - robotOffset1b[3]) / 4,
                    { mode: Jimp.BLEND_DESTINATION_OVER }
                  );
                  robotLeg1 = rob;
                });
                ...
                await Jimp.read(new Jimp(robotLeg2)).then(rob => {
                  ...
                  rob.composite(
                    robotGlow2,
                    (robotOffset2[2] - robotOffset2b[2]) / 6,
                    (robotOffset2[3] - robotOffset2b[3]) / 6,
                    { mode: Jimp.BLEND_DESTINATION_OVER }
                  );
                  rob.rotate(-40);
                  robotLeg2 = rob;
                ...
                await Jimp.read(new Jimp(robotLeg3)).then(rob => {
                  ...
                  rob.composite(
                    robotGlow3,
                    (robotOffset3[2] - robotOffset3b[2]) / 2,
                    (robotOffset3[3] - robotOffset3b[3]) / 2,
                    { mode: Jimp.BLEND_DESTINATION_OVER }
                  );
                  robotLeg3 = rob;
                ...
                ic.composite(
                  robotLeg3,
                  100 + iconSize[0] / 2 - robotOffset3[2] + robotOffset3[0],
                  iconSize[1] / 2 - robotOffset2[3] - robotOffset2[1] + 77
                );
                ic.composite(
                  robotLeg1b,
                  100 +
                    ...
                    robotOffset1[0] +
                    35,
                  iconSize[1] / 2 - robotOffset1[3] - robotOffset1[1] + 70
                );
                ic.composite(
                  robotLeg1c,
                  100 +
                ...
                ic.composite(
                  ...
                  100 +
                    ...
                    robotOffset2[0] -
                    60,
                  iconSize[1] / 2 - robotOffset2[3] - robotOffset2[1] + 75
                );
                ic.composite(
                  robotLeg1,
                  100 + iconSize[0] / 2 - robotOffset1[2] + robotOffset1[0] + 7,
                  iconSize[1] / 2 - robotOffset1[3] - robotOffset1[1] + 70
                );
              }
              ...
              if (useExtra)
                ic.composite(
                  extra,
                  imgOff + iconSize[0] / 2 - size2[0] / 2 + offset2[0],
                ...
                //}
                  ...
                  img.onload = () => {
                    var dArr = [
                      ...
                      s = 2,
                      i = 0,
                      x = canvas.width / 2 - finalSize[0] / 2,
                      y = canvas.height / 2 - finalSize[1] / 2;
